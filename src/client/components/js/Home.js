    ...
    <div className="home">
      ...
      <div className="home__description">
        <main className="container-content">
          ...
          <p>You can use the following demo login. Not connected to backend and some functions disabled since I want to avoid having to store any kind of personal data. Hence registering is also disabled.</p>
