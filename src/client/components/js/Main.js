  ...
  static categorizeFilteredTasks(filteredTasks) {
    ...
    filteredTasks.forEach((task) => {
      switch (task.category) {
        case 'A':
          categorizedFilteredTasks.TasksCatA.push(<Task key={task.id} className="task-category-A" title={task.title} description={task.description} />);
          break;

        case 'B':
          categorizedFilteredTasks.TasksCatB.push(<Task key={task.id} className="task-category-B" title={task.title} description={task.description} />);
          break;

        case 'C':
          categorizedFilteredTasks.TasksCatC.push(<Task key={task.id} className="task-category-C" title={task.title} description={task.description} />);
          break;

        case 'D':
          categorizedFilteredTasks.TasksCatD.push(<Task key={task.id} className="task-category-D" title={task.title} description={task.description} />);
          break;
